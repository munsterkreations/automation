...
Gem::Specification.new do |spec|
  ...
  spec.description = "The DataScraper gem is a versatile tool for scraping data from popular social media platforms like TikTok and Instagram. It provides easy-to-use classes for extracting user information, such as follower counts and following counts. With built-in error handling and customizable configuration options, the DataScraper gem simplifies the process of collecting data from these platforms.  Start scraping user data effortlessly with just a few lines of code"
